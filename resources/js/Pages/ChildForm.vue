<template>
    <section class="container mx-auto px-4 py-8">
        ...
        <div class="gap-6 w-full pb-8">
            <form class="space-y-6 rounded-3xl p-6 shadow-sm border bg-neutral-900 border-neutral-800" @submit.prevent>
                <div>
                    <label class="block text-sm font-semibold mb-1 text-amber-400 w-50">Név</label>
                    <input
                        v-model.trim="form.name"
                        type="text"
                        required
                        class="w-1/2 rounded-xl px-3 py-3 border border-neutral-700 bg-neutral-950 text-neutral-100"
                    />
                </div>
